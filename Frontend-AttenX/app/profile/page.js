...
export default function ProfilePage() {
  ...
  const [profile, setProfile] = useState({
    ...
    language: 'English',
    bio: 'Experienced HR professional with over 8 years in talent management and employee relations. Passionate about creating positive workplace cultures and implementing efficient HR processes.'
  })
  ...
  const recentActivity = [
    {
      action: 'Reviewed anomaly in Sheet #A-2024-001',
      time: '2 hours ago',
      type: 'review'
    },
    {
      action: 'Generated weekly attendance report',
      time: '1 day ago',
      type: 'report'
    },
    {
    ...
    {
      action: 'Processed batch upload of 25 sheets',
      time: '5 days ago',
      type: 'upload'
    }
  ]
        ...
        <div className="space-y-6">
                ...
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex items-start space-x-3">
                    <div className={`flex-shrink-0 w-2 h-2 rounded-full mt-2 ${
                      activity.type === 'review' ? 'bg-red-500' :
                      activity.type === 'report' ? 'bg-green-500' :
                      activity.type === 'profile' ? 'bg-blue-500' : 'bg-amber-500'
                    }`} />
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-amber-200 dark:border-gray-700">
            <div className="p-6">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-between p-3 text-left border border-gray-200 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <div className="flex items-center">
                    <Key className="h-4 w-4 text-amber-500 mr-3" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      Change Password
                    </span>
                  </div>
